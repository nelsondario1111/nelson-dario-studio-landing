    ...
    <div className="container mx-auto px-6">
      ...
      <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
        {projects.map((p) => (
          <div
            key={p.title}
            className="group rounded-xl border border-border bg-card overflow-hidden hover:shadow-lg hover:shadow-foreground/5 transition-all duration-300 hover:-translate-y-1"
          >
